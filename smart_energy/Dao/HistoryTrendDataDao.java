...
public interface HistoryTrendDataDao {
    ...
    @Insert("INSERT INTO `历史趋势数据` (`趋势编号`, `能源类型`, `统计周期`, " +
            "`统计时间`, `能耗或发电量数值`, `同比增长率`, `环比增长率`, `行业均值`) " +
