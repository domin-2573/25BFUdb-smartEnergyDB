...
public interface DashboardConfigDao {
    ...
    @Insert("INSERT INTO `大屏展示配置表` (`配置编号`, `展示模块`, `数据刷新频率`, " +
            "`展示字段`, `排序规则`, `权限等级`) " +
    ...
    @Delete("DELETE FROM `大屏展示配置表` WHERE `配置编号` = #{configId}")
